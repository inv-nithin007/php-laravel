          ...
          {profile && (
            <Box sx={{ mt: 2, mb: 2 }}>
              <Typography color="textSecondary" variant="body2">
                Employee ID: {profile.employee_id} (Read Only)
              </Typography>
              <Typography color="textSecondary" variant="body2">
                Subject Specialization: {profile.subject_specialization} (Read Only)
              </Typography>
              <Typography color="textSecondary" variant="body2">
                Date of Joining: {new Date(profile.date_of_joining).toLocaleDateString()} (Read Only)
              </Typography>
            </Box>
          )}
